function genChemicalPlants(inputs)
    ...
    item.icon =
        "__OD27_5dim_automation__/graphics/icon/chemical-plant/chemical-plant-icon-" .. inputs.number .. ".png"
    ...
    entity.animation.east.layers[1].hr_version.filename =
        "__OD27_5dim_automation__/graphics/entities/chemical-plant/chemical-plant-" .. inputs.number .. ".png"
