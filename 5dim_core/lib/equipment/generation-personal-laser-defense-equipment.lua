function genPersonalLaserDefenses(inputs)
    ...
    item.icon = "__OD27_5dim_equipment__/graphics/icon/personal-laser-defense/personal-laser-defense-equipment-icon-" .. inputs.number .. ".png"
    ...
    equipment.sprite.filename =
        "__OD27_5dim_equipment__/graphics/equipment/personal-laser-defense/personal-laser-defense-equipment-" .. inputs.number .. ".png"
