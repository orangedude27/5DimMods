function genSolarPanels(inputs)
    ...
    item.icon = "__OD27_5dim_equipment__/graphics/icon/solar-panel/solar-panel-equipment-icon-" .. inputs.number .. ".png"
    ...
    equipment.sprite.filename =
        "__OD27_5dim_equipment__/graphics/equipment/solar-panel/solar-panel-equipment-" .. inputs.number .. ".png"
