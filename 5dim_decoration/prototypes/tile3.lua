data:extend(
    {
        -- Item
        {
            type = "item",
            name = "5d-concrete-b2",
            icon = "__OD27_5dim_decoration__/graphics/icon/concreteB2.png",
        ...
        {
            {
                ...
                variants = {
                    main = {
                        {
                            picture = "__OD27_5dim_decoration__/graphics/icon/concrete1B2.png",
                            count = 16,
                            size = 1
                        },
                        {
                            picture = "__OD27_5dim_decoration__/graphics/icon/concrete2B2.png",
                            count = 4,
                            size = 2,
                            probability = 0.39
                        },
                        {
                            picture = "__OD27_5dim_decoration__/graphics/icon/concrete4B2.png",
                            count = 4,
                            size = 4,
                            probability = 1
                        }
