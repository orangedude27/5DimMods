data:extend(
    {
        -- Item
        {
            type = "item",
            name = "5d-concrete-r",
            icon = "__OD27_5dim_decoration__/graphics/icon/concreteR.png",
        ...
        {
            {
                ...
                variants = {
                    main = {
                        {
                            picture = "__OD27_5dim_decoration__/graphics/icon/concrete1R.png",
                            count = 16,
                            size = 1
                        },
                        {
                            picture = "__OD27_5dim_decoration__/graphics/icon/concrete2R.png",
                            count = 4,
                            size = 2,
                            probability = 0.39
                        },
                        {
                            picture = "__OD27_5dim_decoration__/graphics/icon/concrete4R.png",
                            count = 4,
                            size = 4,
                            probability = 1
                        }
