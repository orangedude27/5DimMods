function genChemicalPlants(inputs)
    ...
    item.icon =
        "__OD27_5dim_automation__/graphics/icon/oil-refinery/oil-refinery-icon-" .. inputs.number .. ".png"
    ...
    entity.animation.east.layers[1].hr_version.filename =
        "__OD27_5dim_automation__/graphics/entities/oil-refinery/oil-refinery-" .. inputs.number .. ".png"
