function genPersonalLaserDefenses(inputs)
    ...
    item.icon = "__OD27_5dim_equipment__/graphics/icon/personal-tesla-defense/personal-tesla-defense-equipment-icon-" .. inputs.number .. ".png"
    ...
    equipment.sprite.filename =
        "__OD27_5dim_equipment__/graphics/equipment/personal-tesla-defense/personal-tesla-defense-equipment-" .. inputs.number .. ".png"
