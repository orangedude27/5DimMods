function genStoneWalls(inputs)
    ...
    item.icon =
        "__OD27_5dim_battlefield__/graphics/icon/stone-wall/stone-wall-icon-" .. inputs.number .. ".png"
    ...
    --     "__OD27_5dim_energy__/graphics/entities/laser-turret/laser-turret-" .. inputs.number .. ".png"
